...
turbo.on('chat-update', async (mek) => {
	try {
		...
		const ownerNumber = ['33660217049@s.whatsapp.net'] //turbo owner
//SETTING WeA
...
//CONVERTER
    ...
    case prefix+ 'tovideo':
            ...
            sendMediaURL(from,res.result,'✪ 𝐁𝐘 LIGHT ✪')
            })
            }else {
...
case prefix+ 'creador':
			case prefix+ 'dueño':
                  reply ('Mi creador es LIGHT🥵 MI número Wa.me/+33660217049')
                break
case prefix+ 'tomp3':
